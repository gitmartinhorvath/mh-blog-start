...
function blog_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'hometit', array(
        'title' => __( 'Title-home', 'blog' ),
        'priority' => '1'
    ));

    $wp_customize->add_section( 'imgpost', array(
        'title' => __( 'Image - Post', 'blog' ),
        'priority' => '2'
    ));
    ...
    $wp_customize->add_setting( 'tit-home', array(
        'type' => 'theme_mod',
        'default' => __( 'Our Blog', 'blog' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'tit-home', array(
        'label' => __( 'H1 - title', 'blog' ),
        'type' => 'text',
        'section' => 'hometit'
    ));

    $wp_customize->add_setting( 'subtit', array(
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control( 'subtit', array(
        'label' => __( 'Sub title', 'blog' ),
        'type' => 'textarea',
        'section' => 'hometit'
    ));

    $wp_customize->add_setting( 'img-ch', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'img-ch', array(
...
if ( ! function_exists( 'blog_enqueue_scripts' ) ) :
    ...
    wp_deregister_script( 'blog-scrollmagic' );
    wp_enqueue_script( 'blog-scrollmagic', get_template_directory_uri() . '/js/ScrollMagic.min.js', false, null, true);

    wp_deregister_script( 'blog-scrollmagicanimationgsap' );
    wp_enqueue_script( 'blog-scrollmagicanimationgsap', get_template_directory_uri() . '/js/scrollmagic.animation.gsap.min.js', false, null, true);

    wp_deregister_script( 'blog-debugaddindicators' );
    wp_enqueue_script( 'blog-debugaddindicators', get_template_directory_uri() . '/js/debug.addIndicators.min.js', false, null, true);
